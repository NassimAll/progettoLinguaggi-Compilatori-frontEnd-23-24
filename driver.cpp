...
const std::string& GlobalVariableAST::getName() const { 
   return name; 
};
...
Value *BinaryExprAST::codegen(driver& drv) {
  //Controllo prima che non sia una negazione perchè in caso è composta da un solo operando
  if (Op == 'n'){
...
// *********************** FOR-STATEMENT AST ****************************
ForStmtAST::ForStmtAST(VarBindingAST* Init, ExprAST* Cond, VarBindingAST* Step, RootAST* Body)
